...
# 이미지 세트: 로컬(⓪ cmo/remix_augment 산출) 우선 → 없으면 NAS 논문 정본
_IMG_LOCAL = os.path.join(MODULE_ROOT, 'Output', 'CMO', 'tail_RAB')
_IMG_NAS = r'<DATA_NAS>\MapBuilder\augmented_dataset\CMO_4500'
...
Z_PRIME_SRC_DIR = os.path.join(_IMG_BASE, 'LK_CIR_MER_RAB_FOT')


# ━━ Paths ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ONNX_PATH = (
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "weight", "cp_cnn_iter4.onnx")
)
...
OUTPUT_DIR = os.path.join(os.path.join(MODULE_ROOT, 'Output', 'CMO'), RUN_NAME)
...
def main():
    ...
    print(f"[3/5] Z' embedding 직접 추출: {Z_PRIME_SRC_DIR}")
    zp_paths = sorted(glob.glob(os.path.join(Z_PRIME_SRC_DIR, "*.png")))
