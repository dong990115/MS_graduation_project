...
EMB_PATH = resolve_emb_path("Remix", "Remix_4500", MODULE_ROOT, _EMB_ARGS)
...
V13_SRC_DIR = _IMG_LOCAL if os.path.isdir(os.path.join(_IMG_LOCAL, 'LK_CIR_MER_RAB_FOT')) else r'<DATA_NAS>\MapBuilder\augmented_dataset\Remix_4500'  # 로컬 우선 → NAS 정본
