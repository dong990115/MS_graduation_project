...
_IMG_LOCAL = os.path.join(MONOREPO_ROOT, '05_MapBuilder', 'Output', 'DSM', 'RAB_v13_Train_060126_noLane_sub4500')
_IMG_NAS = r'<DATA_NAS>\MapBuilder\augmented_dataset\PCG_4500'
...
Z_PRIME_SRC_DIRS = [
    ...
    os.path.join(_IMG_BASE, 'drivingAlone_RVL_RAB_FOT'),
]
...
INPUT_PATH = resolve_emb_path("PCG", "noLane_060126_sub4500", MODULE_ROOT, _EMB_ARGS)
